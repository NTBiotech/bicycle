...
DATA_PATH = Path("/data/toulouse/bicycle/notebooks/experiments/masking/data/model_runs/experiments/scale_mask_scMultiSim")
...
iterator1 = [0.01, 0.1, 1., 10.]
iterator2 = [0.0, 0.5, 1.0, 2.0, 5.0]
for n1 in iterator1:
    for n2 in iterator2:
        for r in range(replicates):
            ...
            # data
            data_source = "create_data_scMultiSim"
            data_sem="pert_cif"
